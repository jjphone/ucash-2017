  ...
  <div class="help-wrap">
    <div class="row">
      ...
      <div  id = "guide-details" 
            ...
            > 
        <?php get_template_part('template-parts/help/nav', 'guide-en');  ?>
      </div>
      ...
      <div  id = "borrow-details" 
            ...
            >
        <?php get_template_part('template-parts/help/nav', 'borrow-en');  ?>
      </div>
      ...
      <div  id = "repay-details"
            ...
            >
        <?php get_template_part('template-parts/help/nav', 'repay-en');  ?>
      </div>
